...
POLLITI_APP_ADMIN_USER_PASSWORD_CONFIG_PROPERTY="POLLITIADMIN_USER_PASSWORD"
...
echo -e "\tMaster admin username: ${POLLITI_APP_ADMIN_USER}\n\tMaster admin password: The value of ${POLLITI_APP_ADMIN_USER_PASSWORD_CONFIG_PROPERTY} from ${POLLITI_CONTAINERIZATION_CONFIG}\n\n"
exit 0